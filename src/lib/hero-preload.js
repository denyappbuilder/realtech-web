/**
 * Atributy pro <link rel="preload" as="image"> LCP hero obrázku.
 *
 * Hero má `loading="eager"` + `fetchpriority="high"`, ale prohlížeč ho
 * najde až při parsování <body> — preload v <head> ho pustí do fronty
 * hned se skenem hlavičky. Musí mířit na STEJNÝ soubor, který si
 * <picture> nakonec vybere, jinak se stáhne dvakrát:
 *
 ...
 * - jen plné WebP (bez 640) → preload plného WebP.
 * - jinak JPG / YouTube maxresdefault, s imagesrcset jen když ho má i <img>.
 *
 * Jeden preload na stránku — nic dalšího (karty, loga) se nepreloaduje.
 *
 * @param {{
 *   src?: string | null,
 *   srcset?: string,
