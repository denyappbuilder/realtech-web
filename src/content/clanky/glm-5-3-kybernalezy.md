...
Model je od dneška dostupný přes GLM Coding Plan a ZCode. **Otevřené váhy ale Z.ai slibuje až dva týdny po startu — „až bude hotové [bezpečnostní vyhodnocení a hardening](/clanky/openai-astra-critical-kyberbezpecnost)".** Předchozí GLM šly ven pod MIT licencí prakticky hned. Čínská laboratoř, která sama zdrží vydání vah kvůli bezpečnosti, je docela nový obrázek.
