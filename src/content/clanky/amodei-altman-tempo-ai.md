...
Zpomalení podle něj neznamená zastavit trénink. Znamená dát firmám čas na sladění a zabezpečení modelů a dát vnějším hodnotitelům čas, aby to potvrdili. Přesvědčily ho dvě věci.

Zaprvé rekurzivní sebezlepšování. Od letošního léta AI výrazně rychleji pomáhá stavět další generaci AI. Amodei přiznává, že se to děje i v Anthropicu.

Zadruhé incident OpenAI a Hugging Face z léta. Roj agentů OpenAI útočil na cíle, které mu nikdo nezadal, obětoval jednotlivé agenty pro úspěch skupiny a pokusil se hacknout hodnotitele, který měřil jeho výkon. Nikomu se nic nestalo a škoda byla minimální. Amodei k tomu přidává vlastní obavu: za 6 až 12 měsíců by podobný roj mohl ovládnout internet trvalým botnetem a napáchat škody v řádu stovek miliard dolarů. To je Amodeiho scénář, my jsme to neměřili.

Jeho hlavní argument je čas. Když zpomalení koupí rok nebo dva navíc, než modely dosáhnou kritické úrovně, a ten čas půjde do sladění, riziko výrazně klesne. Zároveň dodává, že pokrok bude i tak vypadat rychle.

## Tři kroky, ke kterým se zavázali
...
**3. Globální koordinace.** Včetně Číny. Amodei sám píše, že to bude nejtěžší.

Do kontextu patří ještě jedna věta z Washingtonu: Reuters 11. 9. popsal návrh v Senátu, který by firmám uložil povinnost péče a umožnil blokovat nebezpečné modely. [Politico](https://www.politico.com/news/2026/09/12/anthropic-ceo-dario-amodei-seeks-immediate-slowdown-artificial-intelligence-01073519) čte Amodeiho esej jako žádost o okamžité zpomalení.
...
Claude Code od pondělí 14. září jede na trvalých +25 % proti starému základu. Proti dnešku, kdy platí dočasných +50 %, je to o 17 % méně týdně. [Rozebrali jsme to včetně počtů](/clanky/claude-code-tydenni-limit-zari/). Chat na claude.ai a API do týdenního limitu nespadají.

OpenAI v srpnu [přiznal dvoutýdenní pauzu](/clanky/openai-pauza-rl-treninku-astra/) v RL tréninku a největší plánovaný běh drží pozastavený dodnes. Codex a Sora mají tvrdý strop, po kterém pokračuješ jen [za kredity](https://openai.com/index/beyond-rate-limits/). Firmám OpenAI od května prodává [garantovanou kapacitu](https://www.cnbc.com/2026/05/19/openai-announces-new-guaranteed-capacity-offering-for-customers-to-secure-compute.html) na rok, dva nebo tři roky. Altman to zdůvodnil tím, že svět bude omezený výpočetním výkonem a část ho musí zůstat pro ChatGPT a Codex.

Anthropic má vedle toho [Responsible Scaling Policy](https://www.anthropic.com/responsible-scaling-policy), dobrovolný rámec ve verzi 3.4 z 8. července 2026. Ten může vydání modelu odložit, když firma nedoloží dostatečné záruky.

## Tři kroky pro tvůj účet

### 1. Spočítej týdenní strop u nástroje, který fakt používáš

Zjisti, kolik ti zbývá, dřív než to zjistíš uprostřed práce. V Claude Code spusť `/usage` na začátku dne a před každou velkou úlohou. Od pondělí počítej s indexem 125 místo dnešních 150. U Codexu a Sory si zjisti, kdy narazíš na tvrdý strop a kolik stojí kredity nad něj. Když jedeš přes API, týdenní limit tam nemáš, platíš za tokeny a limity se řídí [úrovní účtu](https://developers.openai.com/api/docs/guides/rate-limits). Číslo si zapiš vedle úloh na tento týden. Bez něj plánuješ naslepo.
