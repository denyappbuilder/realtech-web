...
Účet přesto může být vysoký. Dlouhá session se čtyřmi subagenty a průběžným zhušťováním kontextu spálí násobně víc tokenů než jeden dotaz na model. Sazbu za kontejner a odhad tokenů si spočítej ještě před nasazením.

## Čísla, která ukazuje OpenAI

Ciridae hlásí skóre ve své evaluaci 0,71 → 0,85 a 4× nižší latenci u toků se subagenty. SafetyKit uvádí o 60 % nižší náklady na jeden případ. Obojí jsou firemní čísla zákazníků bez nezávislého ověření. My jsme neměřili.
...
Když máš smlouvu nebo zákazníka s podmínkou EU residency nebo ZDR, Agents API pro tyhle úkoly teď použít nejde. Nastavení prostředí na tom nic nezmění.

## Rozhodovací pravidlo

**Vezmi Agents API, když:**

- Chceš agenta rozjet během dne. Session, obnova, zhušťování kontextu i subagenti jsou hotové.
...
- Potřebuješ EU data residency nebo ZDR. Bez výjimky.
