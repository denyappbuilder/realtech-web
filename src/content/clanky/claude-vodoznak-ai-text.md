...
Na **soubory** jde podepsaná metadata podle otevřeného standardu **C2PA** — tedy to, co už používá Adobe, OpenAI i Google — ten navíc do [AI avatarů ve Vids](/clanky/google-vids-avatary/) vkládá vlastní neviditelný vodoznak SynthID. Anthropic jmenuje jako podporované typy `.svg`, `.png` a `.jpg`. U souborů navíc podpis prozradí, jestli s nimi někdo manipuloval.
