...
Oficiální účet Claude to napsal v 18:03 UTC. Stejný den to stojí v [oznámení Anthropicu](https://www.anthropic.com/claude-fable-and-mythos-5-1) i v dokumentaci platformy. Výchozí režim je Medium na Claude.ai a v Cowork, High v Claude Code.

## Co je nového

Podle Anthropicu jde o nejpokročilejší modely na světě pro kódování a práci se znalostmi. Na [produktové stránce](https://www.anthropic.com/claude/fable) říkají, že Fable 5.1 je model na úrovni Mythos na dlouhé projekty: agenti přes víc aplikací, kód přes celý projekt, firemní pracovní postupy a čtení diagramů, tabulek a PDF.
...
V oznámení je i citát Jane Street Capital: v interních srovnávacích testech prý Fable 5.1 řeší víc programátorských úloh než Fable 5 nebo Opus 5. Na produktové stránce je věta, že v Devinu přesouvají provoz z Opus 5 na Fable 5.1 v den uvedení. Firmu u toho citátu stránka nejmenuje.
...
Proč to někomu ušetří víc než jiným: kdo pořád dokola posílá stejný začátek požadavku — projekt, systémový pokyn, dlouhé zadání — platí za čtení z mezipaměti. Tam Anthropic srazil cenu. Kdo posílá jednorázové krátké požadavky, uvidí stejnou kartu jako u Fable 5.
...
Kdo Fable 5 volá z aplikace, musí počítat se třemi lámavými změnami. [Poznámky k vydání](https://docs.anthropic.com/en/release-notes/api) z 1. září je jmenují.
...
A když u nového účtu upravíš dřívější tah — systémový pokyn, nástroje nebo starší zprávu — přemýšlení přestane platit. Od 31. srpna 2026 to u nových účtů končí chybou. Nové API účty od dneška nemůžou ručně přepisovat předchozí kontext a přitom přemýšlení zachovat.

Text z modelu nese vodoznak Anthropicu. Mezi voláními nástrojů umí model posílat čitelné průběžné aktualizace, zatím ve zkušební verzi.
