...
Anthropic 10. září vydal čtvrtý Threat Intelligence Report. 154 stran. Osm měsíců, od prosince 2025 do srpna 2026. Sedm oblastí škod. Předchozí tři vyšly v březnu, srpnu a listopadu 2025. Hlavní zpráva letošního vydání se dá říct jednou větou: AI přestala útočníkům pomáhat a začala jejich kampaně řídit.
...
Pro tebe jako obránce se tím mění tři veličiny. Rychlost: průnik za 2 až 3 hodiny. Škála: přes 2 100 sad tokenů z více než 40 tenantů za zhruba 34 hodin. Hloubka: jeden člověk zvládne to, na co dřív potřeboval tým. Níže je to, co z reportu plyne pro firmu s pěti lidmi a bez SOC.
...
- **Teze:** od asistenta k orchestrátorovi. Model už nedostává dílčí dotazy. Dostává cíl a sám řídí postup.

Report nepopisuje postupy útoků. Tenhle článek také ne. Zajímá nás, co z toho plyne pro obranu.
...
**Biologie a konvenční zbraně.** Pět případových studií s dvojím užitím v biologii, šest u konvenčních zbraní. Report technické detaily neuvádí a my také ne. Podstatná je hranice: model pomáhal s věcmi, které mají legitimní i škodlivé použití, a Anthropic řeší, kde tu hranici vést.
...
2. **Statické detekce stárnou rychleji.** Zablokuješ indikátor nebo signaturu a AI útočníkovi přestaví nástroj za hodiny. Spoléhej na chování: nový token z neznámé země, hromadné stahování, přihlášení mimo pracovní dobu. Ne na seznamy hashů.
...
5. **Člověk zůstává u výběru cílů a zpeněžení.** To jsou dvě místa, kde jde útočníka pořád zpomalit. Buď těžký cíl: MFA odolné phishingu, segmentace sítě. A udělej data hůř prodejná: šifrování, minimalizace toho, co vůbec držíš.
...
Zároveň je to zpráva od firmy, která ty modely prodává. Anthropic vidí jen zneužití vlastních modelů. Co běží přes jiné API nebo přes otevřené modely na vlastním železe, v reportu není. Čísla ber jako spodní hranici.
