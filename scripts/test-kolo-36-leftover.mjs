...
test("kolo 36: -nlm.mp3 je NotebookLM Deep Dive, -v3.mp3 krátký přehled", () => {
  ...
  assert.equal(
    jeNotebookLmDeepDive("https://audio.realtech.cz/custom-gpt-konec-migrace-na-pluginy-checklist-nlm-b4c94e83b135.mp3"),
    true,
    "verze v klíči objektu (-nlm-<12 hex>.mp3) místo ?v=",
  );
  assert.equal(jeNotebookLmDeepDive("https://audio.realtech.cz/slug-nlm-b4c94e83b135-v3.mp3"), false, "-nlm- uprostřed názvu nestačí");
