// Kolo 40: stejný princip jako test-related-articles-loader.mjs — frontmatter
// [...id].astro až po chronologickou navigaci jako ESM modul s mockem
// astro:content. Navíc exportuje `asideNejnovejsi` (seznam v aside).
...
export async function load(url, context, nextLoad) {
  ...
  if (pathname === articlePagePathname) {
    ...
    const selectionEnd = astroSource.indexOf('\n// Chronologická navigace', frontmatterStart);
