...
- `xPosts` — volitelný seznam status URL na x.com/twitter.com pro oficiální embed příspěvku z X. Widget se vykresluje hned při načtení stránky (žádné click-to-load) a soubor videa zůstává u X — nikdy nerehostujeme.
